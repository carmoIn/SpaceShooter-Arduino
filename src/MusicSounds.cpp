...
int16_t melodyNever[] = {
    ...
    NOTE_A4, 8, NOTE_A4, 8, NOTE_E5, 4, NOTE_D5, 2
};
...
int16_t melodyIntro[] = {
    ...
    NOTE_AS4,8, NOTE_A4,8, NOTE_G4,8, NOTE_F5,2, NOTE_C5,4,  
    NOTE_AS4,8, NOTE_A4,8, NOTE_AS4,8, NOTE_G4,2
};
...
void playLoseSound()
{
    playSound(melodyNever, 114);
}

void playIntro()
{
    playSound(melodyIntro, 108);
}
...
void playSound(int16_t* melodyNotes, uint8_t tempo)
{
    ...
    int notes = sizeof(melodyNotes) / sizeof(melodyNotes[0]) / 2;
    ...
    for (int thisNote = 0; thisNote < notes * 2; thisNote = thisNote + 2)
    {
        ...
        divider = melodyNotes[thisNote + 1];
        if (divider > 0)
        {
        ...
        tone(BUZZER_PIN, melodyNotes[thisNote], noteDuration * 0.9);
